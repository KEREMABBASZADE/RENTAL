    ...
    <div className="cd__testimonials cd__reviews">
      ...
      {[
        ...
        },
        {
          ...
          text: "The customer support is top-notch. I highly recommend it to anyone looking for a reliable car rental service.MORENT is the best car rental app I have ever used. The service is excellent and the prices are very affordable.",
        },
      ].map((review, i) => (
